...
use crate::{
    ...
    header::{
        ...
        sys_wait,
        time::timespec,
        unistd::{AT_FDCWD, F_OK, R_OK, W_OK, X_OK},
    },
...
impl Pal for Sys {
    ...
    unsafe fn fstatat(
        ...
        let path = if filedes == AT_FDCWD {
            ...
            path::canonicalize_using_cwd(Some(dir), path).ok_or(Errno(ENOENT))?
        };
