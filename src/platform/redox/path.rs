...
pub fn openat2_path(dirfd: c_int, path: &str, at_flags: c_int) -> Result<String, Errno> {
...
// Basically openat2.
pub fn openat2(dirfd: c_int, path: &str, at_flags: c_int, oflags: c_int) -> Result<File, Errno> {
